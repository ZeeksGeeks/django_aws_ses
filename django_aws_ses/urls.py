...
from .views import dashboard, handle_bounce, HandleUnsubscribe, HandleEmailUnsubscribe
...
urlpatterns = [
    ...
    path('unsubscribe/email/<str:encoded_email>/<str:token>/', HandleEmailUnsubscribe.as_view(), name='aws_ses_email_unsubscribe'),
]